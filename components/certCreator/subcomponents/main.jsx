"use client";
import ImageIcon from "@/public/assets/image2.png";
...
const pickerStyles = {
  ...
  const handleEditSave = () =>{
    ...
    console.log(textItems[selectedItemId]);
...
const handleTextMouseDownLogo = (id) => {
  setLogos((prevTextItems) => ({
    ...prevTextItems,
    [id]: {
      ...prevTextItems[id],
      flag: true,
    ...
    return(
        <div style={{
            ...
            >
                ...
                <Image src={ImageIcon} alt="ImageIcon" style={{
                    width:"10rem",
                    height:"auto",
                }}/>
                <div>
                    <input id="image-selector" type="file" onChange={(e)=>handleImageChange(e)} style={{
                       display:"none",
                    }}/>
          ...
          <>
            ...
            <Draggable bounds="parent">
              ...
              >
                ...
                <QRCode value="https://bitmemoir.com" bgColor="transparent" fgColor={qrCodeColor} size={qrCodeSize} />
                  ...
                  <Draggable bounds="parent" key={logo}>
                    <div
                      style={{
                        ...
                        // boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)',
                        zIndex: 1, // Ensure the editing tools are above the canvas
                        border:logo.flag? "1px solid grey" :"",
                      }}

                      onMouseDownCapture={() => handleTextMouseDownLogo(id)}
                      onMouseUpCapture={handleTextMouseUpLogo}
                    ...
                    <Resizable
                          ...
                          handleComponent={{
                            topRight: logo.flag ? <ResizeHandle /> : "",
                            topLeft: logo.flag ? <ResizeHandle /> : "",
                            bottomLeft: logo.flag ? <ResizeHandle /> : "",
                            bottomRight: logo.flag ? <ResizeHandle /> : ""
                          }}
                          resizeRatio={1}
                        >
                      <img
          ...
          {Object.entries(textItems).map(([id, textItem]) => {
            ...
            return(
              ...
              <Draggable
                ...
                onDrag={(e, data) => handleTextDrag(id, { x: data.x, y: data.y })}
              >
                <div
                  style={{
                    top: '50%',
                    ...
                    background: selectedItemId === id ?'rgba(255, 255, 255, 0.8)':"",
                    boxShadow: selectedItemId === id  ?'0 2px 4px rgba(0, 0, 0, 0.2)' :"",
          ...
          {tool === "Add Text" && <div style={{ width: '300px', padding: '16px', background: '#002D36' ,marginLeft:"2rem"}}>
            {editing == 1&&
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ marginBottom: '16px',width: 'fit-content' }}>
                  <label>Font Color: </label>
                    <input style={{marginLeft:"1rem"}} type="color" color={fontColor} onChange={(e) => setFontColor(e.target.value)} />
                </div>
                <div style={{ marginBottom: '16px', width: 'fit-content'}}>
                    ...
                    <div style={{
                      ...
                      <label>
                        <input type="checkbox" checked={isBold} onChange={handleBoldChange} /> Bold
                      </label>
                    </div>
                    <div>
                      <label>
                        <input type="checkbox" checked={isItalic} onChange={handleItalicChange} /> Italic
                      </label>
                    </div>
                  </div>
                <div>
                  {/* {editing !== 1 && <button onClick={handleAddText} 
                  style={{
                    color:"white",
            ...
            {
              tool === "QR Code" &&
              <div style={{ width: '300px', padding: '16px', background: '#002D36' ,marginLeft:"2rem"}}>
                  <div style={{ marginBottom: "16px", width: "fit-content" }}>
            ...
            }
            {
              ...
              <div style={{ width: '300px', padding: '16px', background: '#002D36' ,marginLeft:"2rem"}}>
                  ...
                  >
                    ...
                    <div>
                        <input id="logo-selector" type="file" onChange={(e)=>{
